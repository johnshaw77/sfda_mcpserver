...
{
  "groups": [
    [12.5, 15.2, 13.8, 18.1, 14.7, 16.3, 13.1, 17.9, 15.6, 14.2, 16.8, 13.5, 17.4, 14.9],
    [18.2, 21.7, 19.5, 24.3, 20.1, 22.8, 18.9, 23.6, 21.2, 19.8, 22.4, 19.1, 23.9, 20.7],
    [14.8, 17.3, 15.9, 19.6, 16.5, 18.2, 15.1, 19.8, 17.7, 16.2, 18.9, 15.4, 19.1, 17.0],
    [21.3, 24.8, 22.6, 27.1, 23.2, 25.9, 21.7, 26.4, 24.1, 22.9, 25.5, 22.2, 26.8, 23.7]
  ],
...
```json
{
  "groups": [
    ...
    [99.5, 100.2, 99.8, 100.5, 100.0, 100.3, 99.7, 100.6, 100.1, 99.9, 100.4, 99.8]
  ],
...
```json
{
  "groups": [
    ...
    [5.2, 5.8, 5.5, 6.1, 5.7, 5.9, 5.3, 6.2, 5.6, 5.4, 6.0, 5.5, 5.8, 5.3, 6.1, 5.7, 5.9],
    [8.5, 8.8, 8.2, 9.1, 8.7, 8.9, 8.3, 9.2, 8.6, 8.4, 9.0, 8.5]
  ],
  "group_labels": ["生產部 (n=15)", "研發部 (n=10)", "客服部 (n=17)", "主管層 (n=12)"],
  "title": "各部門員工滿意度比較",

...
| is_suspended | bit(1) | 是 |  |  |  |
| last_suspended_date | datetime | 是 |  |  |  |
| is_update_personal_info | bit(1) | 是 |  |  |  |
| last_update_personal_info_date | varchar(50) | 是 |  |  |  |
| user_type | varchar(50) | 是 |  |  |  |
| card_no | varchar(50) | 是 |  |  |  |
| employee_no | varchar(50) | 是 |  |  |  |
| domain | varchar(50) | 是 |  |  |  |
| account | varchar(50) | 是 |  |  |  |
...
| arrive_date | datetime | 是 |  |  |  |
| leave_date | datetime | 是 |  |  |  |
| birthday | date | 是 |  |  |  |
| sex | varchar(5) | 是 |  |  |  |
| telphone | varchar(50) | 是 |  |  |  |
| ext_num | varchar(50) | 是 |  |  |  |
| mobile | varchar(50) | 是 |  |  |  |
| photo | varchar(50) | 是 |  |  |  |
